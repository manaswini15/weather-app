...
const forecast = (latitude, longitude, callback) => {
    ...
    if(error){
        ...
        callback(undefined, body.current.weather_descriptions[0]+". It is currenly "+ body.current.temperature+" degrees out. It feels like "+body.current.feelslike+" degrees out.")
